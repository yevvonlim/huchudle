...
class FACEPipeline:
    ...
    def invert(self, image, landmark_img, prompt):
        device = self.device
        with torch.no_grad():
        ...
        z = self.diffusion.ddim_reverse_sample_loop(self.model.forward,
    ...
    def edit(self, new_prompt, new_landmark_img, orig_landmark_img, latent, cfg_scale=5., save_img=True):
        ...
        y = [new_prompt, ""]
        landmark_img = torch.cat([new_landmark_img, orig_landmark_img], 0).to(self.device)
